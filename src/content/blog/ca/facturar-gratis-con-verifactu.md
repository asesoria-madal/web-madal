...
title: 'No, no cal pagar cap programa per complir amb Verifactu'
...
Si busques "facturació Verifactu" et trobaràs una allau d'anuncis de programes de pagament. És lògic: és el seu negoci. Però l'obligació legal no diu enlloc que hagis de pagar una subscripció per complir-la.

## El que obliga Verifactu, exactament

Verifactu (Real Decreto 1007/2023) exigeix que el programa amb què factures registri cada factura de manera que no es pugui alterar ni esborrar sense deixar rastre, amb petjada digital i, en molts casos, un codi QR verificable. És una obligació sobre el programari que fas servir, no sobre quant pagues per ell. Ho expliquem amb dates concretes a [Verifactu: què és i quan t'afecta](/ca/blog/verifactu-2026).

## L'alternativa gratuïta: l'aplicació de l'Agència Tributària

Perquè aquesta obligació no acabi obligant de facto a comprar programari, la mateixa Agència Tributària posa a disposició d'autònoms i pimes, a la seva Seu Electrònica. Ideal per a qui es conformi amb un sistema de facturació senzill: genera la factura, la segella amb els requisits de Verifactu (petjada digital, QR) i la desa. S'hi accedeix amb certificat digital, Cl@ve o DNI electrònic, sense instal·lar res.

No és cap secret ni cap truc: és una previsió de la mateixa norma, precisament perquè complir amb Verifactu no depengui de la teva capacitat de pagament.

*(Compte, no ho confonguis amb la factura electrònica obligatòria de la Ley Crea y Crece, que és una obligació diferent amb la seva pròpia eina gratuïta prevista: ho expliquem a [Facturació electrònica obligatòria: què és i en què es diferencia de Verifactu](/ca/blog/facturacion-electronica-obligatoria).)*
