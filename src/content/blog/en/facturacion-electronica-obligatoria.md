...
The most useful thing right now is to check whether your invoicing software can generate structured electronic format (Facturae or other equivalent standards). In practice, this is usually the same technical requirement Verifactu asks for, so checking one leaves you on track for the other.
