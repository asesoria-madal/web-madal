  ...
  es: {
    ...
    blog: {
      ...
      faqAutonomosItems: [
        ...
        { q: '¿Puedo elegir estar en módulos si mi actividad lo permite?', a: 'Sí, si tu actividad está entre las permitidas y no superas los límites de facturación. Si tu actividad es apta para módulos y no haces nada, entras ahí por defecto — para tributar en estimación directa en ese caso, tienes que renunciar expresamente al régimen de módulos.' },
  ...
  ca: {
    ...
    blog: {
      ...
      faqAutonomosItems: [
        ...
        { q: 'Puc estar en mòduls si la meva activitat ho permet?', a: 'Sí, si la teva activitat és de les permeses i no superes els límits de facturació. Si la teva activitat és apta per a mòduls i no fas res, hi entres per defecte — per tributar en estimació directa en aquest cas, has de renunciar expressament al règim de mòduls.' },
  ...
  en: {
    ...
    blog: {
      ...
      faqAutonomosItems: [
        ...
        { q: 'Can I opt for the flat-rate (módulos) regime if my activity qualifies?', a: 'Yes, if your activity is on the allowed list and you stay under the invoicing limits. If your activity qualifies for módulos and you do nothing, you’re enrolled in it by default — to be taxed under direct estimation in that case, you have to expressly opt out of the módulos regime.' },
