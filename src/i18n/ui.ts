...
export const ui = {
  es: {
    ...
    hero: {
      ...
      priceAutonomoLabel: 'Autónomos',
      priceAutonomoAmount: 'desde 35 €',
      priceSlLabel: 'SL y pymes',
      priceSlAmount: 'desde 100 €',
      priceUnit: '/mes',
      priceClaim: 'Precios sin IVA. Incluye todas tus consultas y dudas, sin sorpresas ni letra pequeña.',
      ...
      autonomoTiers: [
        {
          ...
          transitionNote: 'A los 6 meses puedes revisar con nosotros cómo va tu actividad y, si quieres, pasar al plan Esencial en ese momento — la decisión es tuya, no depende de tu facturación. Al finalizar los 12 meses, eliges el plan que mejor se ajuste a lo que necesites.',
        },
        {
          key: 'esencial',
          name: 'Esencial',
    ...
    blog: {
      ...
      faqGeneralesItems: [
        ...
        { q: '¿Quién está obligado a la factura electrónica?', a: 'Todas las empresas y autónomos que facturen a otras empresas o autónomos (operaciones B2B). No afecta a las facturas a particulares, y es una obligación distinta de Verifactu.', related: 'facturacion-electronica-obligatoria' },
    ...
    servicios: {
      ...
      dashboards: {
        ...
        sub: 'Además de llevar tu contabilidad, te damos acceso a dashboards personalizados desde tu área de cliente: te ayudan a ver en qué se te va el dinero, a anticipar cómo va tu negocio, y a saber cuánto vas a tener que pagar en tus próximos impuestos sin esperar a la época de presentarlos. Se actualizan cada semana.',
        from: '"Mi gestoría lleva mis números."',
        to: '"Puedo ver y entender cómo está funcionando mi negocio."',
        items: [
          { strong: 'Ingresos y gastos del mes', rest: ', clasificados por tipo y categoría.' },
          { strong: 'IVA estimado del trimestre', rest: ' — antes de que llegue la fecha de presentación.' },
          { strong: 'Importe estimado de tus próximos impuestos', rest: ' (111, 130, 303 y los que te correspondan).' },
          { strong: 'Predicción de ingresos y gastos', rest: ', disponible en cuanto tengamos histórico suficiente (a partir del 4.º mes de datos).' },
        ],
        detail: 'Si en algún momento necesitas algo distinto, nos lo dices y lo ajustamos.',
    ...
    portal: {
      ...
      dashboards: {
        ...
        reportingOffIntro: 'Todavía no tienes el reporting activo. Te ayuda a ver en qué se te va el dinero, anticipar cómo va tu negocio y saber cuánto vas a pagar en tus próximos impuestos sin esperar a la época de impuestos. Actívalo y verás aquí, actualizado cada semana:',
        reportingOffList: [
          { strong: 'Ingresos y gastos del mes', rest: ', clasificados por tipo y categoría.' },
          { strong: 'IVA estimado del trimestre', rest: ' — antes de que llegue la fecha de presentación.' },
          { strong: 'Importe estimado de tus próximos impuestos', rest: ' (111, 130, 303 y los que te correspondan).' },
  ...
  ca: {
    ...
    hero: {
      ...
      priceAutonomoLabel: 'Autònoms',
      priceAutonomoAmount: 'des de 35 €',
      priceSlLabel: 'SL i pimes',
      priceSlAmount: 'des de 100 €',
      priceUnit: '/mes',
      priceClaim: 'Preus sense IVA. Inclou totes les teves consultes i dubtes, sense sorpreses ni lletra petita.',
      ...
      autonomoTiers: [
        {
          ...
          transitionNote: 'Als 6 mesos pots revisar amb nosaltres com va la teva activitat i, si vols, passar al pla Essencial en aquell moment — la decisió és teva, no depèn de la teva facturació. En acabar els 12 mesos, tries el pla que millor s\'ajusti al que necessitis.',
        },
        {
          key: 'esencial',
          name: 'Essencial',
    ...
    blog: {
      ...
      faqGeneralesItems: [
        ...
        { q: 'Qui està obligat a la factura electrònica?', a: 'Totes les empreses i autònoms que facturin a altres empreses o autònoms (operacions B2B). No afecta les factures a particulars, i és una obligació diferent de Verifactu.', related: 'facturacion-electronica-obligatoria' },
      ...
      faqSlItems: [
        ...
        { q: 'Quins són els passos per crear una SL?', a: 'Cinc: certificació del nom al Registre Mercantil Central, obertura de compte bancari per al capital, escriptura pública davant notari, NIF provisional i alta censal a Hisenda, i inscripció al Registre Mercantil de la teva província.', related: 'como-se-constituye-una-sl' },
        { q: 'Què surt millor per al cotxe de la meva SL: compra, rènting o lísing?', a: 'Si el cotxe tindrà ús privat del soci o administrador, l’estalvi es redueix molt per la retribució en espècie i la via de finançament importa poc. Si és 100% per treballar: rènting per no gestionar res, lísing per avançar deducció si te’l quedes, compra si et sobra tresoreria.', related: 'coche-sl-renting-leasing-compra' },
        { q: 'Com tributa el cotxe d’empresa que també es fa servir per a fins personals?', a: 'La part d’ús privat s’imputa com a retribució en espècie a la nòmina de qui el fa servir: 20% anual del cost d’adquisició si el cotxe és de l’empresa, o del valor de mercat del vehicle nou si és rènting o lísing, amb fins a un 30% de reducció per a vehicles eficients. Ben imputada, continua sent despesa deduïble per a la SL; l’ús privat no declarat, no.', related: 'coche-sl-renting-leasing-compra' },
      ],
    ...
    servicios: {
      ...
      dashboards: {
        ...
        sub: 'A més de portar la teva comptabilitat, et donem accés a dashboards personalitzats des de la teva àrea de client: t’ajuden a veure en què se’t va els diners, a anticipar com va el teu negoci, i a saber quant hauràs de pagar dels teus propers impostos sense esperar a l’època de presentar-los. S’actualitzen cada setmana.',
        from: '"La meva gestoria porta els meus números."',
        to: '"Puc veure i entendre com funciona el meu negoci."',
        items: [
          { strong: 'Ingressos i despeses del mes', rest: ', classificats per tipus i categoria.' },
          { strong: 'IVA estimat del trimestre', rest: ' — abans que arribi la data de presentació.' },
          { strong: 'Import estimat dels teus propers impostos', rest: ' (111, 130, 303 i els que et corresponguin).' },
          { strong: 'Predicció d’ingressos i despeses', rest: ', disponible quan tinguem prou històric (a partir del 4t mes de dades).' },
        ],
        detail: 'Si en algun moment necessites alguna cosa diferent, ens ho dius i ho ajustem.',
    ...
    portal: {
      ...
      dashboards: {
        ...
        reportingOffIntro: 'Encara no tens el reporting actiu. T’ajuda a veure en què se’t va els diners, anticipar com va el teu negoci i saber quant hauràs de pagar dels teus propers impostos sense esperar a l’època d’impostos. Activa’l i veuràs aquí, actualitzat cada setmana:',
        reportingOffList: [
          { strong: 'Ingressos i despeses del mes', rest: ', classificats per tipus i categoria.' },
          { strong: 'IVA estimat del trimestre', rest: ' — abans que arribi la data de presentació.' },
          { strong: 'Import estimat dels teus propers impostos', rest: ' (111, 130, 303 i els que et corresponguin).' },
  ...
  en: {
    ...
    hero: {
      ...
      priceAutonomoLabel: 'Freelancers',
      priceAutonomoAmount: 'from €35',
      priceSlLabel: 'Companies',
      priceSlAmount: 'from €100',
      priceUnit: '/month',
      priceClaim: 'Prices exclude VAT. Includes every question and call you need, no surprises, no fine print.',
      ...
      autonomoTiers: [
        {
          ...
          transitionNote: 'At 6 months you can check in with us and, if you\'d like, move to the Essential plan then — it\'s your call, not based on your revenue. At the end of 12 months, you choose whichever plan fits what you need.',
        },
        {
          key: 'esencial',
          name: 'Essential',
    ...
    blog: {
      ...
      faqGeneralesItems: [
        ...
        { q: 'Who is required to use electronic invoicing?', a: 'Every company and self-employed worker that invoices another company or self-employed worker (B2B transactions). It doesn’t affect invoices to individuals, and it’s a separate obligation from Verifactu.', related: 'facturacion-electronica-obligatoria' },
      ...
      faqSlItems: [
        ...
        { q: 'What are the steps to set up an SL?', a: 'Five: a name certificate from the Central Companies Registry, opening a bank account for the share capital, a public deed before a notary, a provisional tax ID and tax registration with Hacienda, and registration with the Companies Registry for your province.', related: 'como-se-constituye-una-sl' },
        { q: 'What’s better for my company car: buying, long-term rental or leasing?', a: 'If the car will have personal use by the owner or director, the saving shrinks a lot because of the benefit in kind, and the financing route matters little. If it’s 100% for work: renting to avoid all admin, leasing to bring the deduction forward if you keep it, buying if you have spare cash.', related: 'coche-sl-renting-leasing-compra' },
        { q: 'How is a company car that’s also used for personal purposes taxed?', a: 'The personal-use portion is charged as a benefit in kind on the user’s payroll: 20% per year of the acquisition cost if the company owns the car, or of the new vehicle’s market value if it’s on rental or lease, with a reduction of up to 30% for energy-efficient vehicles. Handled properly, it’s still a deductible expense for the company; undeclared personal use is not.', related: 'coche-sl-renting-leasing-compra' },
      ],
    ...
    servicios: {
      ...
      dashboards: {
        ...
        sub: 'On top of handling your accounting, we give you access to personalized dashboards from your client area: they help you see where your money is going, get ahead of how your business is doing, and know how much you’ll owe in upcoming taxes without waiting for tax season. Updated every week.',
        from: '"My accounting firm handles my numbers."',
        to: '"I can see and understand how my business is doing."',
        items: [
          { strong: 'Income and expenses for the month', rest: ', broken down by type and category.' },
          { strong: 'Estimated VAT for the quarter', rest: ' — before the filing deadline arrives.' },
          { strong: 'Estimated amount of your upcoming taxes', rest: ' (111, 130, 303 and whichever apply to you).' },
          { strong: 'Income and expense forecast', rest: ', available once we have enough history (from month 4 of data onward).' },
        ],
    ...
    portal: {
      ...
      dashboards: {
        ...
        reportingOffIntro: 'You don’t have reporting active yet. It helps you see where your money is going, get ahead of how your business is doing, and know how much you’ll owe in upcoming taxes without waiting for tax season. Turn it on and you’ll see here, updated every week:',
        reportingOffList: [
          { strong: 'Income and expenses for the month', rest: ', broken down by type and category.' },
          { strong: 'Estimated VAT for the quarter', rest: ' — before the filing deadline arrives.' },
          { strong: 'Estimated amount of your upcoming taxes', rest: ' (111, 130, 303 and whichever apply to you).' },
